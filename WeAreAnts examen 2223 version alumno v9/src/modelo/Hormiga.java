...
public class Hormiga {
	...
	/**
	 * calcula el indice actual de salubridad/poder que le permite recoger
	 * el alimento, o no y al final de su vida, crear un objeto de tipo
	 * IdoneidadADN
	 * @return
	 */
